...
pub(super) const STRINGS: Strings = Strings {
    window_title: "Claude Code 使用量監控 — trelowney",
    refresh: "重新整理",
    ...
    second_suffix: "秒",
    session_reset_title: "5 小時用量已重置",
    session_reset_body: "您的 {model} 5 小時用量視窗已重置。",
    weekly_reset_title: "7 天用量已重置",
    weekly_reset_body: "您的 {model} 7 天用量視窗已重置。",
    session_high_usage_title: "5 小時用量警告",
    session_high_usage_body: "您的 {model} 5 小時用量已超過 80%。",
    weekly_high_usage_title: "7 天用量警告",
    weekly_high_usage_body: "您的 {model} 7 天用量已超過 80%。",
};
